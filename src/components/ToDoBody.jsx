        ...
        <div className='relative'>
            <div className='flex h-[80vh] w-[70vw] mx-auto mt-5 flex-col md:flex-row'>
                ...
                <div className="box border-1 border-black/20 w-[100%] md:w-[50%] rounded-r-xl shadow-md p-5">
                    <div className="header text-[1.25rem] font-semibold text-gray-800/80 font-serif">Add a task</div>
                    ...
                    <p className='my-5 text-[1.1rem] text-gray-800/80 font-semibold font-serif'>Your saved tasks:</p>
                            ...
                            todos.map((item) => (
                                <div key={item.id} className="tasks flex items-center justify-between w-full overflow-y-auto mb-2">
                                    <div className='flex items-start gap-3 w-[80%]'>
                                        ...
                                        />
                                        <div className={item.isCompleted ? "text-green-600 text-[1.05rem]" : "w-[80%] text-gray-800 text-[1.05rem]"}>
                                            {item.todo}
                                        </div>
                                    </div>
                                    <div className="buttons flex items-center gap-2 w-[20%]">
                                        <div className="button" onClick={(e) => handleEdit(e, item.id)}>
                                            <img src={edit_icon} alt="edit" className='h-10 cursor-pointer' />
                                        </div>
                                        <div className="button" onClick={(e) => handleDelete(e, item.id)}>
